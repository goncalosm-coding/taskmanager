...
const Navbar = () => {
  ...
  return (
    <div className='flex justify-between items-center bg-white px-4 py-3 2xl:py-4 sticky z-10 top-0'>Navbar
        <div className='flex gap-4'>    
            <button onClick={() => dispatch(setOpenSidebar(true))}className='text-2xl text-gray-500 block md:hidden'>

            </button>

            <div className='w-64 2xl:w-[400px] flex item-center py-2 px-3 gap-2 rounded-full bg-[#f3f4f6]'>
